...
<div class="card bordered flex flex-col items-center shadow-md overflow-hidden mb-2" on:dblclick={like}>
    ...
    <div class="card-body w-full py-2 px-4 bg-gray-100 flex items-center">
        <div class="like__container">
            ...
            <button class="btn btn-primary self-end" on:click={toggleListen}>
                {#if isListening}
        ...
        <div class="comment__container comment-box">
            <button class="text-slate-400" on:click={toggleComments}>View all {comments.length} comments</button>
            {#if showComments}
            <div class="comments">
        ...
        <div class="w-full h-16 relative">
            ...
            <button class="btn btn-primary absolute bottom-1 right-1" on:click={addComment}>
        ...
        <div class="social-media-buttonsg">
            <button class='btn btn-primary' on:click={shareToWhatsApp}>
            ...
            <button class='btn btn-primary' on:click={shareToTwitter}>
            ...
            <button class='btn btn-primary' on:click={shareToInstagram}>
